...
more cases in the reference source code, but these cases aren't essential to our
discussion.
...
It is simplified to
never fail for conciseness, but it can indeed fail in the reference source code.
...
modifications can be found in the files \patchfile{ifl25-liquidhaskell.patch} and \patchfile{ifl25-liquid-fixpoint.patch}.
