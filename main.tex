...
When the invariants of a program naturally involved mathematical objects such as
...
are easier both to understand to fix, provided that the user goal is feasible.
