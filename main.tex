...
\begin{itemize}
  ...
  \item Signatures are expressed with \emph{refinement types} of the form
        \tc{\{x:b | p\}}, which denote values of type base type \tc{b} that
...
idInt x = x
\end{verbatim}
We say that \tc{p} is an abstract predicate, and is inferred by Liquid Haskell
...
An incorrect assumption could make Liquid Haskell accept programs that don't
