...
\setcopyright{cc}
\setcctype{by}
\acmConference[IFL 2025]{The 37th Symposium on Implementation and Application of Functional Languages}{October 01--03, 2025}{Montevideo, Uruguay}
\acmBooktitle{The 37th Symposium on Implementation and Application of Functional Languages (IFL 2025), October 01--03, 2025, Montevideo, Uruguay}
\acmDOI{10.1145/3839837.3839841}
\acmISBN{979-8-4007-2654-5/2025/10}
...
needs to be a subtype of the return refinement type of function \tc{f}.

Similarly, in an application \tc{f y}, the refinement type of \tc{y} needs
to be a subtype of the refinement type of the parameter of \tc{f}:
\begin{verbatim}
{-@ g :: {x:Int | x > 2} -> {x:Int | x > 0} @-}
g :: Int -> Int
g y = f y
\end{verbatim}
...
wanted to add the scope checks
