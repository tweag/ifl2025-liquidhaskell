...
SMT solvers, even though the technology is not really ready yet. Our case study
...
The sources of all of these defects seem to locate in the Liquid Haskell
implementation rather than the SMT solver. Fortunately, none of them look very
...
we feel like using the type-checker is among the most pragmatic. \Citeauthor{maclaurin23} make
